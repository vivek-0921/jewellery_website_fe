                ...
                <Grid container sx={{ alignItems: 'center' }}  >
                    <Grid item md={4} sx={{ display: { xs: 'none', md: 'block' } }}>
                        <ul style={{ backgroundColor: "white", marginRight: '40px', padding: "10px 20px 60px 60px", borderRight: '1px solid #D4D5D9' }}>
                            {/* <Link to={'/account'} Categ><li style={{ color: '#AA7B49', display: 'flex', alignItems: 'center' , borderBottom: '1px solid #D4D5D9' ,padding:'10px 0'  }}><PersonIcon style={{ margin: '10px 25px 10px 0px', fontWeight: '600' }} /><Typography sx={{ fontSize: "20px", fontWeight: '600' }}> Personal Information </Typography></li></Link> */}
                        ...
                        <Container maxWidth="lg" >
                            ...
                            <Box sx={{ margin: '20px 0', padding: { md: '50px 150px', xs: "30px 10px" }, borderRadius: '8px', border: '1px solid #D4D4D9' }}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                                    <Link to='/accountedit' >
                                        <Button color='white' sx={{ backgroundColor: '#AA7B49', border: 'none', color: 'black', width: "100%" }} >Edit</Button>
                                    </Link>
                                </Box>
                            </Box>
                        </Container>
