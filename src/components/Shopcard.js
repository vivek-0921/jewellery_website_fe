...
function Shopcard() {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_URL}/product/allproduct`)
            ...
            <Box sx={{backgroundColor: "#FFF9F4"}}>
                ...
                <Box sx={{
                    ...
                    <Swiper slidesPerView={3} spaceBetween={30} freeMode={true} pagination={{clickable: true}}
                            loop={true} modules={[FreeMode, Autoplay]} className="mySwiper"
                            autoplay={{delay: 10, disableOnInteraction: false}} speed={8000}>
                        ...
                        <Grid item lg={3} sx={{backgroundColor: '#F5E7D6'}}>
                            ...
                            <Box sx={{height: "auto", border: '1px solid #E5E5E5', margin: '20px 0 ', padding: '20px'}}>
                                <Box>
                                    ...
                                    }}>Filter By Categories</Typography>
                                </Box>
                                        ...
                                        product_type.map((item, index) => {
                                            return (
                                                <ul style={{
                                                    ...
                                                    <li style={{padding: '4px 0px'}}><Typography sx={{
                                                        color: 'black',
                                                        fontSize: '14px',
                                                        cursor: 'pointer',
                                                        "&:hover ": {color: "#AC805D"}
                                                    }}>{item.name}</Typography></li>
                                                    <li>{item.quantity}</li>
                                                </ul>
                                            )
                                        })
                            ...
                            <Box sx={{height: "auto", border: '1px solid #E5E5E5', margin: '20px 0 ', padding: '20px'}}>
                                ...
                                <Box sx={{marginTop: "10px"}}>
                                    <Box sx={{width: 300}}>
                                        <Slider getAriaLabel={() => 'Temperature range'} value={value}
                                                onChange={handleChange} valueLabelDisplay="auto"
                                                getAriaValueText={valuetext}/>
                                    </Box>
                                    <Typography className='Marcellus' sx={{fontSize: "19px"}}>Price: 30.00$ —
                                        40.00$</Typography>
                                </Box>
                            </Box>
                        </Grid>
                        ...
                        <Grid item lg={9} sx={{
                        ...
                        }}>
                            {
                                products.map((item, index) => {
                                    ...
                                    return (
                                        <Link to={'/singleproduct'} key={item.id || item.name}>
                                            <Box id='mainbox' sx={{
                                                marginTop: '30px',
                                                height: {sm: "529px", xs: '450px'},
                                                width: {sm: "293px", xs: '230px'},
                                                margin: {sm: ' 50px 25px ', xs: '30px 60px'},
                                                pb: 20
                                            }}>
                                                <Box onMouseEnter={() => handleMouseEnter(index)}
                                                     onMouseLeave={handleMouseLeave} sx={{
                                                    backgroundImage: `url(${hoveredImage === index ? `${process.env.REACT_APP_API_URL}/${item.image}` : item.image})`,
                                                    transition: '0.25s',
                                                    height: "100% ",
                                                    width: 'auto',
                                                    ...
                                                    }}><FavoriteBorderIcon sx={{color: 'white'}}/></Box>
                                                    <Box sx={{
                                                        height: '40px',
                                                        width: "92%",
                                                        backgroundColor: "black",
                                                        ...
                                                        "&:hover ": {color: 'white', backgroundColor: "#AC805D"}
                                                    }}>Select Option</Box>
                                                </Box>
                                                <Typography className='Marcellus' sx={{
                                                    textAlign: 'center',
